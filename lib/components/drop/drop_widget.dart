...
class _DropWidgetState extends State<DropWidget> with TickerProviderStateMixin {
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'ksctuonp' /* randy.p@domainname.com */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
