import '/components/drop/drop_widget.dart';
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  'https://szgohtdnamsqaduvbhoi.supabase.co/storage/v1/object/sign/Files/307465245_406368285022099_1347403456248866661_n.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJGaWxlcy8zMDc0NjUyNDVfNDA2MzY4Mjg1MDIyMDk5XzEzNDc0MDM0NTYyNDg4NjY2NjFfbi5wbmciLCJpYXQiOjE3MDU1NDMwNDgsImV4cCI6MjU2OTQ1NjY0OH0.-Tti4UIDD8tIK2vJd66U3Y8LEzpOR0q35VTL-komVjU&t=2024-01-18T01%3A57%3A28.079Z',
                                  width: 300.0,
                                  height: 100.0,
                                  fit: BoxFit.cover,
                                ),
                                  ...
                                  builder: (context) => MouseRegion(
                                    ...
                                    onEnter: ((event) async {
                                      ...
                                      await showAlignedDialog(
                                        ...
                                        avoidOverflow: true,
                                        targetAnchor:
                                            const AlignmentDirectional(1.0, 10.0)
                                                .resolve(
