...
class JobBoardGoogleSheetSupabaseSupabaseUser extends BaseAuthUser {
  JobBoardGoogleSheetSupabaseSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> jobBoardGoogleSheetSupabaseSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          JobBoardGoogleSheetSupabaseSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
